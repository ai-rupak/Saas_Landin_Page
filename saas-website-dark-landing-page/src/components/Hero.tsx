    ...
    <div className="container relative"> 
      ...
      <div className='flex justify-center mt-8'>
        <div className='inline-flex relative'>
          ...
          <motion.div className='absolute right-[476px] top-[108px] hidden sm:inline ' drag dragSnapToOrigin><Image src={cursorImage} height="200" width="200" alt = "" className='max-w-none' draggable="false"/></motion.div>
          <motion.div className='absolute top-[56px] left-[490px] hidden sm:inline' drag dragSnapToOrigin><Image src={messageImage} alt=""height="200" width="200" className='max-w-none' draggable="false"/></motion.div>
        </div>
      </div>
